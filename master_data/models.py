...
class Material(models.Model):
    ...
    stock_unit        = models.CharField(max_length=50, blank=True, null=True)
    base_unit         = models.CharField(max_length=50, blank=True, null=True)
    conversion_factor = models.DecimalField(max_digits=10, decimal_places=4, blank=True, null=True)
