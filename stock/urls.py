...
urlpatterns = [
    ...
    path('pricing/',               views.stock_pricing,    name='stock_pricing'),
    path('pricing/save/<int:pk>/', views.stock_price_save, name='stock_price_save'),
    path('item-info/',             views.get_item_info, name='get_item_info'),
]